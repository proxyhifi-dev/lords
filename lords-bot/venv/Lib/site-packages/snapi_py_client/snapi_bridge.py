...
#             print('sessionToken',data['sessionToken'])
   ...
   #---------------------------------------------------------------- ORDERS ---------------------------------------------------------------------------------#     
    ...
    def modify_order(self,order_number, **kwargs):  # noqa: E501
        ...
        :param ModifyOrderRequest body: Type of order. L - Limit Order, SL - Stop Loss Limit
        :return: OrderResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
...
#             raise ValueError("Invalid value for parameter `from_date` when calling `get_index_candle_data`, must conform to the pattern `/([12]\\d{3}-(0[1-9]|1[0-2])-(0[1-9]|[12]\\d|3[01]))/`")  # noqa: E501
    ...
    def ip_registration(self, **kwargs):
            """IP Registration API

            This method registers IP details using POST API.
            ...
            if kwargs.get('async_req'):
                return self.ip_registration_with_http_info(**kwargs)
            else:
                data = self.ip_registration_with_http_info(**kwargs)
                return data    
                
    def ip_registration_with_http_info(self, **kwargs):
            """IP Registration API with HTTP info"""
            ...
            for key, val in six.iteritems(params['kwargs']):
                if key not in all_params:
                    raise TypeError(
                        "Got an unexpected keyword argument '%s' to method ip_registration" % key
                    )
                params[key] = val
            del params['kwargs']
            ...
            data = self.api_client.call_api(
                ...
                post_params=form_params,
                files=local_var_files,
                response_type='IpRegistrationResponse',
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
    ...
    def ip_update(self, **kwargs):
            """IP Update API

            This method updates IP details using POST API.
            ...
            if kwargs.get('async_req'):
                return self.ip_update_with_http_info(**kwargs)
            else:
                data = self.ip_update_with_http_info(**kwargs)
                return data    
                
    def ip_update_with_http_info(self, **kwargs):
            """IP Update API with HTTP info"""
            ...
            for key, val in six.iteritems(params['kwargs']):
                if key not in all_params:
                    raise TypeError(
                        "Got an unexpected keyword argument '%s' to method ip_update" % key
                    )
                params[key] = val
            del params['kwargs']
            ...
            data = self.api_client.call_api(
                ...
                post_params=form_params,
                files=local_var_files,
                response_type='IpUpdateResponse',
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
    ...
    def generate_otp(self, **kwargs):
            ...
            This method generates an OTP using POST API.
            ...
            if kwargs.get('async_req'):
                return self.generate_otp_with_http_info(**kwargs)
            else:
                data = self.generate_otp_with_http_info(**kwargs)
                return data    
                
    def generate_otp_with_http_info(self, **kwargs):
            """Generate Otp API with HTTP info"""
            ...
            for key, val in six.iteritems(params['kwargs']):
                if key not in all_params:
                    raise TypeError(
                        "Got an unexpected keyword argument '%s' to method generate_otp" % key
                    )
                params[key] = val
            del params['kwargs']
            ...
            data = self.api_client.call_api(
                ...
                post_params=form_params,
                files=local_var_files,
                response_type='GenerateOtpResponse',
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
    ...
    def generate_secret_api_key(self, **kwargs):
            """Generate Secret API Key

            This method generates a secret API key using POST API.

            :param async_req bool
            :param dict body:
            :return: GenerateSecretAPIKeyResponse
            """

            kwargs['_return_http_data_only'] = True

            if kwargs.get('async_req'):
                return self.generate_secret_api_key_with_http_info(**kwargs)
            else:
                data = self.generate_secret_api_key_with_http_info(**kwargs)
                return data    
                
    def generate_secret_api_key_with_http_info(self, **kwargs):
            """Generate Secret API Key API with HTTP info"""
            ...
            for key, val in six.iteritems(params['kwargs']):
                if key not in all_params:
                    raise TypeError(
                        "Got an unexpected keyword argument '%s' to method generate_secret_api_key" % key
                    )
                params[key] = val
            del params['kwargs']
            ...
            data = self.api_client.call_api(
                '/otp/secretKeyGenerator',  # endpoint
                'POST',
                path_params,
                query_params,
                header_params,
                ...
                post_params=form_params,
                files=local_var_files,
                response_type='GenerateSecretAPIKeyResponse',
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
    ...
    def generate_access_token(self, **kwargs):
            ...
            This method generates an access token using POST API.
            ...
            if kwargs.get('async_req'):
                return self.generate_access_token_with_http_info(**kwargs)
            else:
                data = self.generate_access_token_with_http_info(**kwargs)
                return data    
                
    def generate_access_token_with_http_info(self, **kwargs):
            """Generate Access Token API with HTTP info"""
            ...
            for key, val in six.iteritems(params['kwargs']):
                if key not in all_params:
                    raise TypeError(
                        "Got an unexpected keyword argument '%s' to method generate_access_token" % key
                    )
                params[key] = val
            del params['kwargs']
            ...
            data = self.api_client.call_api(
                ...
                post_params=form_params,
                files=local_var_files,
                response_type='GenerateAccessTokenResponse',
                auth_settings=auth_settings,
                async_req=params.get('async_req'),
                _return_http_data_only=params.get('_return_http_data_only'),
                _preload_content=params.get('_preload_content', True),
